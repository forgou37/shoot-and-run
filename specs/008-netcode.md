...
| **013** | Polish (dedicated-server): spectators, reconnection, metrics/telemetry, anti-cheat posture, lag-comp tuning — **planning**, own spec (specs/013-netplay-polish.md). **Reordered ahead of 012**: these five ride the existing 011 dedicated host and need no player-hosting; host migration split out to 012. | — | **011 ✓** |
